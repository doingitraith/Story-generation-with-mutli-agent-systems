...
\usepackage[style=numeric,backend=biber]{biblatex}% add defernumbers=true
...
\usepackage{listings}
\lstloadlanguages{TeX, C++, XML, Matlab, Java, Python, C, [Sharp]C} % add languages if needed 
\lstset{%
	%language=[LaTeX]TeX,     %
	...
	tabsize=4,               % size of tab indentation
...
\captionsetup[lstlisting]{justification=justified, labelsep=period, skip=10pt}
